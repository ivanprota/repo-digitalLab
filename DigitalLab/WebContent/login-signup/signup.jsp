...
<html lang="IT">
	...
	<head>
		...
		<style type="text/css">
			...
			section .signin .content .form .inputBox:nth-child(2) {
				margin-top: 20px;
				margin-bottom: 0;
			}
			
			section .signin .content .form .inputBox:nth-child(1) {
				margin-top: 0;
			}
			
			section .signin .content .form .inputBox:nth-child(5) {
				margin-bottom: 20px;
			}
...
<body>
	...
	<section>
		    ...
		    <div class="signin">
		    	<div class="content">
		        	<h2>Registrazione</h2>
		        	<p id="signupErrorMessage"><%= error%></p>
		        	<div class="form">
