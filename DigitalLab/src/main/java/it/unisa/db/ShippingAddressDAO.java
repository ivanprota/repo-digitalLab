...
public class ShippingAddressDAO 
{
	...
	public synchronized void doSave(ShippingAddress shippingAddress) throws SQLException
	{
		...
		String insertSQL = "INSERT INTO " +Constants.SHIPPING_ADDRESS_TABLE_NAME+ " VALUES (?, ?, ?, ?, ?, ?, ?)";
		
		try
		{
			connection = ds.getConnection();
			preparedStatement = connection.prepareStatement(insertSQL);
			preparedStatement.setInt(1, shippingAddress.getId());
			preparedStatement.setString(2, shippingAddress.getProvince());
			preparedStatement.setString(3, shippingAddress.getStreet());
			preparedStatement.setString(4, shippingAddress.getCity());
			preparedStatement.setString(5, shippingAddress.getZip());
			preparedStatement.setInt(6, shippingAddress.getStreetNumber());
